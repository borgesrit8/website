              ...
              <Reveal key={ev.id} delay={i * 0.1} className="relative pl-16 md:pl-0">
                ...
                >
                  ...
                  <div className="md:w-1/2 mt-6 md:mt-0">
                    <h3 className="font-display text-2xl md:text-3xl text-cream mb-2">{ev.name}</h3>
                    ...
                    <p className="text-cream/60 text-sm leading-relaxed mb-5">{ev.description}</p>
                    <Link
                      to="/gallery"
                      data-cursor-hover
                      className="inline-flex items-center gap-2 text-sm text-pink hover:text-gold transition-colors"
                    >
                      Ver galeria <FiArrowRight />
                    </Link>
                  </div>
                </div>
              </Reveal>
